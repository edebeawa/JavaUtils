...
public class ConstructorWrapper<T> extends AccessibleObjectWrapper<Constructor<?>, ConstructorWrapper<?>, ConstructorInfo> {
    ...
    static {
        try {
            NATIVE_CONSTRUCTOR_ACCESSOR_IMPL_NEW_INSTANCE_METHOD = ReflectionUtils.getAccessibleDeclaredMethod(Class.forName("sun.reflect.NativeConstructorAccessorImpl"), "newInstance0", Constructor.class, Object[].class);
