...
public class MethodWrapper<T> extends AccessibleObjectWrapper<Method, MethodWrapper<?>, MethodInfo> {
    ...
    static {
        try {
            NATIVE_METHOD_ACCESSOR_IMPL_INVOKE_METHOD = ReflectionUtils.getAccessibleDeclaredMethod(Class.forName("sun.reflect.NativeMethodAccessorImpl"), "invoke0", Method.class, Object.class, Object[].class);
