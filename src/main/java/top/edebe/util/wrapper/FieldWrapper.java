...
public class FieldWrapper<T> extends AccessibleObjectWrapper<Field, FieldWrapper<?>, FieldInfo> {
    ...
    @SuppressWarnings("unchecked")
    public T getNoRestrict(final @NotNull Object object) {
        return (T) UnsafeUtils.UNSAFE_INSTANCE.getObject(object, fieldOffset);
    }

    @SuppressWarnings("unchecked")
    public T getStaticNoRestrict() {
        return (T) UnsafeUtils.UNSAFE_INSTANCE.getObject(this.getBase(), fieldOffset);
    }
    ...
    public void setNoRestrict(final @NotNull Object object, final T value) {
        UnsafeUtils.UNSAFE_INSTANCE.putObject(object, fieldOffset, value);
    }

    public void setStaticNoRestrict(final T value) {
        UnsafeUtils.UNSAFE_INSTANCE.putObject(this.getBase(), fieldOffset, value);
    }
}