...
public class ThrowableUtils {
    ...
    public static String getStackTraceString(@NotNull Throwable throwable, @NotNull Charset charset) throws UnsupportedEncodingException {
        return ThrowableUtils.getStackTraceByteArrayOutputStream(throwable).toString(charset.name());
    }
