...
public class ClassResourceContext {
    ...
    public ClassResourceContext(final @Nullable ClassLoader loader) {
        if (loader != null) {
            this.getResourceFunction = loader::getResource;
            this.getResourceAsStreamFunction = loader::getResourceAsStream;
        }
        else {
            this.getResourceFunction = ClassLoader::getSystemResource;
            this.getResourceAsStreamFunction = ClassLoader::getSystemResourceAsStream;
        }
    }
